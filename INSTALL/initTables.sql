...
('interval_syncGameTime','5',NULL),
('interval_syncOnlinePlayers','10',NULL),
('MAX_RESULT','100',NULL),
('MIN_SLEEP','0',NULL),
('MAX_SLEEP','4',NULL),
...
('interval_syncGameVersion','300',NULL),
('interval_syncServerInfo','120',NULL),
('interval_syncLandclaims','300',NULL),
('interval_syncEntities','10',NULL),
('interval_syncAllPlayers','600',NULL),
('interval_syncGameLog','300',NULL),
('PURGE_APP_LOG_DAYS','4','How long to keep the app log in DAYS.'),
('PURGE_PLAYER_HISTORY_ROWS','150',NULL),
('interval_insertPlayerHistory','30',NULL),
('interval_syncGameChat','1',NULL),
