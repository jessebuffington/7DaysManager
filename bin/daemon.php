...
class System_Daemon
{
    ...
    static protected $_optionDefinitions = array(
        ...
        'authorName' => array(
            'type' => 'string/0-50',
            'punch' => 'Author name',
            'example' => 'Jesse Buffington',
            'detail' => 'Required for forging init.d script',
        ),
        'authorEmail' => array(
            'type' => 'string/email',
            'punch' => 'Author e-mail',
            'example' => 'bassmastry101@gmail.com',
            'detail' => 'Required for forging init.d script',
        ),
        'appName' => array(
            'type' => 'string/unix',
            'punch' => 'The application name',
            'example' => 'syncgametime',
        ...
        'logLocation' => array(
            ...
            'example' => '../var/log/syncGameTime.log',
        ...
        'appPidLocation' => array(
            ...
            'example' => '../var/run/syncGameTime.pid',
            'detail' => '',
            'required' => true,
        ),
        'appChkConfig' => array(
